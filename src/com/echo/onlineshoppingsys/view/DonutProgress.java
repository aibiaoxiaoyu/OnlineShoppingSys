package com.echo.onlineshoppingsys.view;
...
import com.echo.onlineshoppingsys.util.Utils;
...
public class DonutProgress extends View {
    ...
    private static final String INSTANCE_EXTRA = "extra";
    ...
    protected void initPainters() {
        ...
        extraPaint = new TextPaint();
        extraPaint.setColor(textColor);
        extraPaint.setTextSize(extraTextSize);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        extraTextSize = attributes.getDimension(R.styleable.DonutProgress_donut_extra_text_size, default_text_size);
        ...
        if (attributes.getString(R.styleable.DonutProgress_donut_extra_text) != null) {
        	extraText = attributes.getString(R.styleable.DonutProgress_donut_extra_text);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = prefixText + progress;
        if (!TextUtils.isEmpty(text)) {
            float textHeight = textPaint.descent() + textPaint.ascent();
            canvas.drawText(text+suffixText, (getWidth() - textPaint.measureText(text)) / 2.0f - Utils.dp2px(getResources(), 4) , (getWidth() - textHeight) / 2f, textPaint);
            canvas.drawText(extraText, (getWidth() - extraPaint.measureText(extraText)) / 2.0f, (getWidth() - textHeight) / 2.0f - Utils.dp2px(getResources(), 22), extraPaint);
            extraPaint.setTextSize(Utils.dp2px(getResources(), 18));
            //canvas.drawText(suffixText, getWidth() / 4.0f + Utils.dp2px(getResources(), 4) + extraPaint.measureText(text), (getWidth() - textHeight) / 2.0f, extraPaint);
        }
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putString(INSTANCE_EXTRA, getExtraText());
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if(state instanceof Bundle) {
            ...
            extraText = bundle.getString(INSTANCE_EXTRA);
